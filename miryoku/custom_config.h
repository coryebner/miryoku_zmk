...
&kp LCTRL,     &kp Q,             &kp S,                   &kp E,           &kp G,                   &kp N,             &kp M,             &kp COMMA,         &kp DOT,           &kp SLASH, \
U_NP,          U_NP,              U_LT(U_GAME_MEDIA, Z),   &kp SPACE,       U_LT(U_GAME_MOUSE, X),   &kp ENTER,         &kp BSPC,          &kp DEL,           U_NP,              U_NP
...
&kp LCTRL,     &kp C,             &kp S,                 &kp V,             &kp B,              U_NA,              U_NA,             U_NA,             U_NA,             U_NA, \
U_NP,          U_NP,              U_NA,                  U_NA,              U_NA,                 U_NA,              U_NA,             U_NA,             U_NA,             U_NA   

#define MIRYOKU_LAYER_GAME_MOUSE \
&kp N6,        &kp N7,            &kp N8,                &kp N9,            &kp T,                U_NA,              U_NA,             U_NA,             U_NA,             U_NA, \
&kp LSHFT,     &kp A,             &kp W,                 &kp D,             &kp H,                U_NA,              U_NA,             U_NA,             U_NA,             U_NA, \
&kp LCTRL,     &kp N,             &kp S,                 &kp M,             &kp COMMA,                U_NA,              U_NA,             U_NA,             U_NA,             U_NA, \
U_NP,          U_NP,              U_NA,                  U_NA,              U_NA,                 U_NA,              U_NA,             U_NA,             U_NA,             U_NA
...
#define MIRYOKU_KLUDGE_THUMBCOMBOS_RIGHT 39 40
     ...
     &kp Z     K20  K21  K22  K23  K24       K25  K26  K27  K28  K29  XXX \
                         K32  K33  K34       K35  K36  K37
     ...
     &kp KP_NUMLOCK  K10  K11  K12  K13  K14       K15  K16  K17  K18  K19  &trans \
     &kp X           K20  K21  K22  K23  K24       K25  K26  K27  K28  K29  XXX \
                               K32  K33  K34       K35  K36  K37
#endif

#if defined MIRYOKU_KEYBOARD_TBKMINI_ADAPTERV2
     #define MIRYOKU_LAYERMAPPING_GAME( \
          K00, K01, K02, K03, K04,      K05, K06, K07, K08, K09, \
          K10, K11, K12, K13, K14,      K15, K16, K17, K18, K19, \
          K20, K21, K22, K23, K24,      K25, K26, K27, K28, K29, \
